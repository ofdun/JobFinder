...
Необходимо создать приложение для поиска работы. В приложении должна быть обеспечена возможность как поискка работы со стороны соискателя, так и поиск соискателя со стороны работодателя. Требуется добавить уникальную "фишку" сервиса --- использование систем искуственного интеллекта для поиска соискателя по описанию.

# Анализ предметной области
Существуют соискатели и работодатели. У соискателей есть резюме. Работадатели размещают вакансии, на которые соискатели могут оставлять отклики с прикреплением резюме.В резюме должно указываться владение языками, технические навыки, категория резюме (IT, закупки, маркетинг и т.д.), опыт работы и образование.
...
2. Открытое API. Наличиие открытого доступа к API помогает работодателю использовать сервис в своей внутренней системе.

3. Автоматизированные средства поиска соискателей. Наличие подобных средств снижает нагрузку работодателя при поиске сотрудников.


| Платформа     | Доступность в РФ | Открытое API | Автоматизированные средства поиска соискателей |
|---------------|---------------|-----|--------------------|
...
# Use-case диаграмма
![Use-case диаграмма](./usecase.svg)

# ER-диаграмма сущностей
![ER-диаграмма диаграмма](./er-puml.svg)
