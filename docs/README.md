...
### UML диаграмма классов для модуля авторизации
![UML диаграмма классов для модуля авторизации](./img/auth.svg)
### L4 диаграмма всех классов
![UML диаграмма классов](./img/code.svg)
